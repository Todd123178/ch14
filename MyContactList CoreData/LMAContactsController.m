...
- (void)viewDidLoad
{
    ...
    UILongPressGestureRecognizer *longPressText = [[UILongPressGestureRecognizer alloc]
                                               initWithTarget:self
                                               action:@selector(textPhone:)];
    [_txtCell addGestureRecognizer:longPressText];
...
- (void)textPhone:(UILongPressGestureRecognizer*)gesture {
    if (gesture.state == UIGestureRecognizerStateBegan) {
        NSLog(@"Long Press");
        NSString *textURL = [NSString
                              stringWithFormat:@"sms://%@", _txtCell.text];
