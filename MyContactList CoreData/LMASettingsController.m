...
-(void) updateLabel: (CMAccelerometerData *) data
{
    ...
    [UIView animateWithDuration:0 delay:0                                         //9
                     ...
                     completion:nil];
    [_sliderX setValue:data.acceleration.x];
    [_sliderY setValue:data.acceleration.y];
    [_sliderZ setValue:data.acceleration.z];
    
}

- (void)accelerometer:(UIAccelerometer *)accelerometer didAccelerate:(UIAcceleration *)acceleration {
    _labelX.text = [NSString stringWithFormat:@"%@%f", @"X: ", acceleration.x];
    _labelY.text = [NSString stringWithFormat:@"%@%f", @"Y: ", acceleration.y];
    _labelZ.text = [NSString stringWithFormat:@"%@%f", @"Z: ", acceleration.z];
